...
from torch.dict._contextlib import LAST_OP_MAPS
...
class TensorDictBase(MutableMapping):
    ...
    def _new_unsafe(cls, *args, **kwargs):
        ...
        # highly abstract).
        from torch.dict._td import TensorDict
    ...
    def _get_sub_tensordict(self, idx: IndexType) -> T:
        ...
        from torch.dict._td import _SubTensorDict
    ...
    def from_dict_instance(
        ...
        *others,
        ...
        Examples:
            >>> from torch.dict import TensorDict, tensorclass
            >>> import torch
            >>>
            >>> @tensorclass
            >>> class MyClass:
        ...
        *,
        ...
        Examples:
            ...
            PersistentTensorDict(
                ...
                is_shared=False)
        """
        from torch.dict.persistent import PersistentTensorDict
    ...
    def from_modules(
        ...
        *modules,
        ...
        if lazy_stack:
            ...
            from torch.dict._torch_func import _stack_uninit_params
        ...
        if as_module:
            from torch.dict.nn import TensorDictParams
    ...
    def to_module(
        ...
        *,
        ...
        Examples:
            >>> from torch.dict import from_module
            >>> module = nn.TransformerDecoder(
            ...     decoder_layer=nn.TransformerDecoderLayer(nhead=4, d_model=4),
            ...     num_layers=1)
            >>> params = TensorDict.from_module(module)
    ...
    def _legacy_unsqueeze(self, dim: int) -> T:
        ...
        from torch.dict._lazy import _UnsqueezedTensorDict
    ...
    def _legacy_squeeze(self, dim: int | None = None) -> T:
        from torch.dict._lazy import _SqueezedTensorDict
    ...
    def stack(cls, input, dim=0, *, out=None):
        ...
        """
        from torch.dict._torch_func import _stack
    ...
    def cat(cls, input, dim=0, *, out=None):
        ...
        """
        from torch.dict._torch_func import _cat
    ...
    def _legacy_view(
        ...
        *shape: int,
        ...
        if shape == self.shape:
            return self
        from torch.dict._lazy import _ViewedTensorDict
    ...
    def _legacy_transpose(self, dim0, dim1):
        ...
        if dim0 == dim1:
            return self
        from torch.dict._lazy import _TransposedTensorDict
    ...
    def _legacy_permute(
        ...
        *dims_list: int,
        ...
        from torch.dict._lazy import _PermutedTensorDict
    ...
    def _reduce_vals_and_metadata(self, *, dtype=NO_DEFAULT, requires_metadata):
        ...
        if requires_metadata:
            # metadata is nested
            cls = type(self)
            from torch.dict._reductions import CLS_MAP
    ...
    def _set_non_tensor(self, key: NestedKey, value: Any):
        if isinstance(key, tuple):
            ...
            return self
        from torch.dict.tensorclass import NonTensorData
    ...
    def _get_non_tensor(self, key: NestedKey, default=NO_DEFAULT):
        ...
        if is_non_tensor(value):
            from torch.dict import NonTensorStack
    ...
    def from_any(
        ...
        *,
        ...
        if is_tensor_collection(obj):
            ...
            #     from torch.dict.tensorclass import LazyStackedTensorDict
        ...
        if isinstance(obj, list):
            if _is_list_tensor_compatible(obj)[0]:
                ...
                from torch.dict.tensorclass import NonTensorStack
    ...
    def from_dataclass(
        ...
        *,
        ...
        """
        if as_tensorclass:
            from torch.dict.tensorclass import from_dataclass
    ...
    def split_keys(
        ...
        *key_sets,
        ...
        Examples:
            ...
            >>> print(td_bc)
        """
        from torch.dict import PersistentTensorDict
...
def _default_is_leaf(cls: Type) -> bool:
    ...
    Examples:
        >>> from torch.dict import TensorDict, default_is_leaf
        >>> import torch
