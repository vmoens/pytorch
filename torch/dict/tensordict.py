...
class TensorDict(TensorDictBase):
    ...
    def _from_module(
        ...
        if as_module:
            from torch.dict.nn.params import TensorDictParams
...
def from_modules(
    *modules,
    ...
    Examples:
        >>> from torch import nn
        >>> from torch.dict import from_modules
        >>> torch.manual_seed(0)
...
def load_memmap(
    ...
    *,
    ...
    Examples:
        >>> from torch.dict import TensorDict, load_memmap
