...
from torch.dict._pytree import _register_td_node
from torch.dict._td import is_tensor_collection, NO_DEFAULT, TensorDict, TensorDictBase
...
from torch.dict.utils import (  # @manual=//pytorch/tensordict:_C
    _GENERIC_NESTED_ERR,
...
def _tensorclass(cls: T, *, frozen, shadow: bool) -> T:
    ...
    from torch.dict import _pytree
...
class NonTensorStack(LazyStackedTensorDict):
    ...
    Examples:
        >>> from torch.dict import NonTensorData
        >>> import torch
        >>> data = torch.stack([
