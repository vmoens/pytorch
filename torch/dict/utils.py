...
if TYPE_CHECKING:
    from torch.dict.tensordict import TensorDictBase
...
def _set_item(
    ...
    if isinstance(tensor, Tensor):
        tensor[index] = value
        return tensor
    from torch.dict.tensorclass import NonTensorData, NonTensorStack
...
def _check_keys(
    ...
    from torch.dict.base import _is_leaf_nontensor
